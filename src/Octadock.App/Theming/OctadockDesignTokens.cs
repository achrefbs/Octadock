...
internal static class OctadockDesignTokens
{
    public static class Brushes
    {
        ...
        public static readonly SolidColorBrush GlassBorder = Frozen(0x3C, 0xFF, 0xFF, 0xFF);
        public static readonly SolidColorBrush Text = Frozen(0xFF, 0xF1, 0xF5, 0xF9);
        public static readonly SolidColorBrush TextMuted = Frozen(0xB0, 0xCB, 0xD5, 0xE1);
    ...
    {
        public static readonly CornerRadius Window = new(16);
